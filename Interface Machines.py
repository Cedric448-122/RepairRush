...
machines = [
    ...
    Machine("Fraiseuse", 80, 7),      # Dégradation rapide
    Machine("Fraiseuse Avancée", 80, 4), # Dégradation modérée
    Machine("Perceuse", 80, 6),       # Dégradation rapide
    Machine("Perceuse Avancée", 80, 2),  # Machine avancée, très petite dégradation
]
